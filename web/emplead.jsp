                        ...
                        <div class="col-sm-12" style="max-height:500px;overflow-y:scroll;">
                            <table id="Table">
                                ...
                                <%                                    LeadBean lb = new LeadBean();
                                    ArrayList<LeadBean> arr = lb.show(enterpriseId);
                                ...
                                <tr>
                                    ...
                                    <td><a href="editlead.jsp?contact=<%=lbs.getLeadPh()%>" class="btn btn-primary">Edit</a></td>
                                    <td><a href="http://localhost:8080/CustomerRelationshipManagement/DeleteLead?contact=<%=lbs.getLeadPh()%>"><button class="btn btn-danger" disabled>Delete</button></a></td>
                                </tr>
                                <% }%>
                            </table>
                        </div>
