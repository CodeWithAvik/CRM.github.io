<%-- 
    Document   : lead
    Created on : 30 Apr, 2023, 12:15:58 AM
        ...
        <div class="row d-flex d-sm-block flex-nowrap wrapper">
            ...
            <main class="col-sm-10 col px-5 pl-sm-2 pt-2 main mx-auto">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="addlead.jsp" class="btn btn-success">Add New Lead</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12" style="max-height:520px;overflow-y:scroll;">
                        <table id="Table">
                            <tr class="header">
                                <th>Name</th>
                                <th>Email</th>
                             ...
                             <%
                                    ...
                                    ArrayList<LeadBean> arr = lb.show(id);
                                    for (LeadBean lbs : arr) {
                                %>
                                <tr>
                                    <td><%=lbs.getLeadName()%></td>
                                    <td><%=lbs.getLeadMail()%></td>
                                    <td><%=lbs.getLeadPh()%></td>
                                    <td><%=lbs.getInterIn()%></td>
                                    <td><%=lbs.getInterAct()%></td>
                                    <td style="border:0px"><a href="editlead.jsp?contact=<%=lbs.getLeadPh()%>" class="btn btn-primary">Edit</a></td>
                                    <td style="border:0px"><a href="http://localhost:8080/CustomerRelationshipManagement/DeleteLead?contact=<%=lbs.getLeadPh()%>" class="btn btn-danger"
                                                              onclick="
