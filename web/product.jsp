                        ...
                        <div class="col-sm-12" style="max-height:500px;overflow-y:scroll;">
                            <table id="Table">
                                ...
                                <%
                                    ...
                                    ArrayList<ProductBean> arr = pb.show(id);
                                ...
                                <tr>
                                    ...
                                    <td style="border:0px"><a href="http://localhost:8080/CustomerRelationshipManagement/DeleteProduct?id=<%=product.getProductId()%>" class="btn btn-danger" onclick="
